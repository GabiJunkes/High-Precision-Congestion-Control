...
```
docker run --rm -v "$(pwd)/simulation:/hpcc" -w /hpcc hpcc /bin/bash -c 'cd traffic_gen; python2 ./traffic_gen.py -c FbHdp_distribution.txt -n 128 -l 0.3 -b 100G -t 0.1 -o 30_traffic.txt' 

docker run --rm -v "$(pwd)/simulation:/hpcc" -w /hpcc hpcc /bin/bash -c 'cd traffic_gen; python2 ./traffic_gen.py -c FbHdp_distribution.txt -n 128 -l 0.5 -b 100G -t 0.1 -o 50_traffic.txt'

docker run --rm -v "$(pwd)/simulation:/hpcc" -w /hpcc hpcc /bin/bash -c 'cd traffic_gen; python2 ./traffic_gen.py -c FbHdp_distribution.txt -n 128 -l 0.7 -b 100G -t 0.1 -o 70_traffic.txt'
 
docker run --rm -v "$(pwd)/simulation:/hpcc" -w /hpcc hpcc /bin/bash -c 'cd traffic_gen; python2 ./traffic_gen.py -c FbHdp_distribution.txt -n 128 -l 0.9 -b 100G -t 0.1 -o 90_traffic.txt'
```
